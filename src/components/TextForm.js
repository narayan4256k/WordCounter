...
export default function TextForm(props) {
  ...
  return (
    ...
    <div className='container my-5' style={{color: props.mode === 'dark' ? 'white' : 'black'}}>      
       <h1>{props.heading}</h1>  
        <div className="mb-3">
        <textarea className="form-control" style={{backgroundColor: props.mode === 'dark' ? 'rgb(90 127 199)' : 'white', color: props.mode === 'dark' ?'white':'black'}} id="myText" value={text} onChange={handleOnChange} rows="10"></textarea>
        </div>
